...
<div class="container-fluid">
  ...
  <ul class="nav flex-column">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <i class="bi bi-textarea"></i><strong> Área </strong>
        </div>
        <hr>
      ...
      <h2></h2>
          ...
          <!-- <form action="prcd/proceso_agregar_usr.php" method="POST"> -->
              ...
              <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" aria-describedby="Text" name="areaN" id="areaN" REQUIRED>
                      <small id="emailHelp" class="form-text text-muted">Agregar área</small>
                  </div>
                </div>
                <div class="col-6"> 
                  <div class="form-group">
                    <label for="exampleFormControlSelect1">Seleccionar responsable de la actividad</label>
                    <select class="form-control" id="areaR" name="areaR" REQUIRED>
              ...
              <button class="btn btn-primary" onclick="agregarArea()"><i class="fas fa-save"></i> Registrar área</button>
