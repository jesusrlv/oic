...
<ul class="nav flex-column">
 ...
 <li class="nav-item">
   <a class="nav-link active" href="trimestre3.php">
     <span data-feather="layers"></span>
     Tercer trimestre
   </a>
 </li>
                    ...
                    while($row = $resultadotabla->fetch_assoc()){
                        ...
                        echo '<tr>';
                            ...
                            if($row['porcentaje3']!=100){
                              echo utf8_encode('<td><a href="agregar_archivos.php?id=3&act='.$row['id'].'" class="badge badge-info"><i class="fas fa-plus-circle"></i> Evidencia</a></td>');
                            }
                            else{
                            ...
                            echo '<td><center><a href="evidencia_trimestre.php?ev=3&act='.$row['id'].'" class="badge badge-info"><i class="fas fa-eye"></i> '.$num_rows.'</a></center></td>';
                            echo '<td><center>
                            <div class="progress">
                            ...
                            // echo '<td><center><a href="evidencia_trimestre.php?ev=3&act='.$row['id'].'" class="badge badge-info"><i class="bi bi-calendar2-week-fill"></i> '.$row['fecha_inicio3'].'/'.$row['fecha_final3'].'</a></center></td>';
                            ...
                            echo utf8_encode('<td><small>'.$row['observaciones3'].'</small></td>');
                            ...
                            echo '<div class="modal fade" id="exampleModal'.$row['id'].'" tabindex="-1" aria-labelledby="exampleModalLabel'.$row['id'].'" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                  ...
                                  <input value="3" name="trimestre" hidden>
