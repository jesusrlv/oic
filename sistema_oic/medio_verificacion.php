   ...
   <li class="nav-item">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h3">MODIFICAR MEDIO VERIFICACIÓN</h1>
          ...
          <div class="col mb-4">
            <div class="card text-white bg-dark mb-6" style="max-width: 36rem; height: 27rem;">
              ...
              <div class="card-body"><br><br><br>
                ...
                <p><button type="button" class="btn btn-warning"><i class="fas fa-edit"></i> Editar...</button></p>
              </div>
            </div>
          </div>
          <div class="col mb-4">
        ...
        <div class="col mb-12">
          <div class="card text-white bg-warning mb-12 align-middle" style="max-width: 96rem;">
            ...
            <div class="card-body">
              ...
              <button type="button" class="btn btn-primary btn-lg btn-block"><i class="fas fa-edit"></i> Modificar</button>
            </div>
          </div>
        </div>
      </div> -->
