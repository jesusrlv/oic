...
$tabla="SELECT * FROM actividad WHERE responsable='$id' AND annio = '$annio' AND estatus = 1 ";
                    ...
                    while($row = $resultadotabla->fetch_assoc()){
                      ...
                      $fecha1 = $row['fecha_inicio3'];
                      $fecha2 = $row['fecha_final3'];
                      ...
                      <div class="accordion-item mt-1">
                        <h2 class="accordion-header">
                          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#accordion3'.$numero.'" aria-expanded="true" aria-controls="collapseOne">
                          '.$numero.' - '.$row['actividad'].'
                          </button>
                        </h2>
                        <div id="accordion3'.$numero.'" class="accordion-collapse collapse" data-bs-parent="#accordionExample3">
                          <div class="accordion-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-2 border">
                                <a href="evidencia_trimestre.php?ev=3&act='.$row['id'].'&annio='.$row['annio'].'">
