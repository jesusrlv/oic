...
$tabla="SELECT * FROM actividad WHERE responsable='$id' AND annio = '$annio' AND estatus = 1";
                    ...
                    while($row = $resultadotabla->fetch_assoc()){
                        ...
                        echo '<tr>';
                            ...
                            echo '<td><center><button class="btn btn-info btn-sm" onclick="fechas('.$row['id'].',2)"><small><i class="bi bi-calendar2-week-fill"></i> '.$fecha_inicio_mx.' - '.$fecha_final_mx.'</button></center></small></td>';
