                    ...
                    while($row = $resultadotabla->fetch_assoc()){
                      ...
                      <div class="accordion-item mt-1">
                        <h2 class="accordion-header">
                          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#accordion'.$numero.'" aria-expanded="true" aria-controls="collapseOne">
                          '.$numero.' - '.$row['actividad'].'
                          </button>
                        </h2>
                        <div id="accordion'.$numero.'" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                          <div class="accordion-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-2 border">
                                <a href="evidencia_trimestre.php?ev=1&act='.$row['id'].'&annio='.$row['annio'].'">
