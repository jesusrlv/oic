   ...
   <li class="nav-item">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <div class="row">
        ...
        <div class="col">
            <div class="input-group mb-3">
                    <label class="input-group-text" for="selectTrimestre"><i class="bi bi-stack"></i></label>
                    <select class="form-select" id="selectTrimestre" onchange="tablero()">
